...
PRO sam_dis_cluster_kmeans, num_class, MaxIteration, minChangeThreshold

  ;选择需要聚类的图像
  infile = 'C:\Program Files\Exelis\ENVI53\data\qb_boulder_msi'
  if (infile eq '') then return
  ENVI_OPEN_FILE, infile, r_fid=fid1
  ENVI_FILE_QUERY, fid1, dims=dims, nb=nb

  ;选择聚类后聚类图像的存储路径
  outfile = 'd:\sam_dis_test' 
